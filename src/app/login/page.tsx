        ...
        >
           ...
           <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <button 
                ...
                style={{ height: '60px', padding: '0 32px', fontSize: '1.2rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', background: 'rgba(255,255,255,0.05)', borderColor: 'rgba(0,210,255,0.3)', color: '#fff' }}
              >
                ...
                <span className="mono" style={{ fontWeight: 600 }}>CONNECT_GOOGLE</span>
              </button>
